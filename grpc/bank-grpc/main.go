...
func main() {
	...
	bankRepositories, err := repositories.NewDBManager()
	if err != nil {
		panic(err)
	}

	h, err := handlers.NewBankHandler(bankRepositories)
	if err != nil {
		panic(err)
	}

	reflection.Register(s)
	pb.RegisterBankServiceServer(s, h)
